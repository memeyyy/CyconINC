            ...
            <div class="modal-body mx-3">
                ...
                <form method="POST"  action="project_action.php?proj_ID=<?php echo $proj_ID;  ?>">
                    <div class="md-form row">
                        ...
                        <div class="col-6 col-md-6">
                            <i class="fa fa-user prefix grey-text"></i>
                            <input placeholder="Quantity" type="text" id="form5" class="form-control" name="material_Qty" required="">
                        </div>
                        <div class="col-6 col-md-6">
                            <input placeholder="Price " type="text" id="form5" class="form-control" name="material_Price"  required="">
                        </div>
                    </div>
                     <div class="md-form">
                        <center>
...
<div class="modal fade" id="modaladdtrans" tabindex="0" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                ...
                <div class="col-6 col-md-6">
                    <i class="fa fa- prefix grey-text"></i>
                    <input placeholder="Amount" type="text" id="amount" class="form-control" name="amount" required="">
                 </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
            	...
            	<form action="project_action.php?proj_ID=<?php echo $proj_ID?>" method="POST">
            		

                <div class="md-form">
                        <center>
                            <div class="btn-group">
                                <input type="submit" name="submit_transaction" value="Receive" class="btn btn-dark-green">
                            </div>
