...
{           
            ...
            $connection = mysqli_connect("localhost", "root", "","cycon_inc"); // Establishing Connection with Server by passing server_name, user_id and password as a parameter
            $query = mysqli_query($connection,"SELECT * FROM user_account WHERE username='$user'"); 
    ...
    <body>
        ...
        <div class="container">
            ...
            <section class="section pb-3 text-center text-lg-left">
                <?php 
            $connection = mysqli_connect("localhost", "root", "","cycon_inc");
            $sql_info = mysqli_query($connection,"SELECT * FROM `cycon_info`");
