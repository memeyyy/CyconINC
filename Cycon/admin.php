    ...
    <nav class="navbar navbar-expand-lg navbar-dark  fixed-top scrolling-navbar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto ">
                    ...
                    <li class="nav-item ml-2">
                        <a class="nav-link" href="#">Project Monitoring</a>
                    </li>
                    <li class="nav-item ml-2">
                        <a class="nav-link" href="#pb-3">Warehouse Inventory</a>
                    </li>
                    <li class="nav-item ml-2">
                        <a class="nav-link" href="#pb-3">Payment Transaction</a>
                    </li>
                    <li class="nav-item ml-2">
                        <a class="nav-link" href="#pb-3">Report</a>
                    </li>
            ...
            <div class="float-right">
                <button type="button" class="btn btn-dark-green"><i class="fa fa-user"></i></button>
            </div>
