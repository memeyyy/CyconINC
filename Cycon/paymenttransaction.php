    ...
    <section class="portfolio" id="portfolio" >
      <div class="container">
        <table  id="example" class="table table-bordered table-advance table-hover  dataTable" >
          <thead>
            <tr>
              <th class="col-sm-1 text-center">Project Title</th>
              <th class="col-sm-1 text-center">Project Owner</th>
              <th class="col-sm-2 text-center">Location</th>
              <th class="col-sm-1 text-center">Date Content</th>
              <th class="col-sm-1 text-center">Date of Completion</th>
              <th class="col-sm-1 text-center">Cost</th>
              <th class="col-sm-1 text-center">Project Status</th>
              <th class="col-sm-1 text-center">Payment Status</th>
              <th class="col-sm-1 text-center">Technical Emplope(s)</th>
